function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://129.151.121.64:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosGame(id) {
    $.ajax({
        dataType: 'JSON',
        url:"http://129.151.121.64:8080/api/Game/"+id,
    ...
    if($("#name2").val().length == 0 || $("#developer").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://129.151.121.64:8080/api/Game/save",
    ...
    $.ajax(
        {
            dataType: 'JSON',
            data: dataToSend,
            url:"http://129.151.121.64:8080/api/Game/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#developer").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.121.64:8080/api/Game/update",
